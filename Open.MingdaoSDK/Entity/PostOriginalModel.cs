...
namespace Open.MingdaoSDK.Entity
{
    ...
    [Serializable]
    [XmlRoot("result")]
    public class PostOriginalResultModel
    {
        private Collection<PostOriginalModel> postoriginal = new Collection<PostOriginalModel>();
        [XmlElement("post")]
        public Collection<PostOriginalModel> PostOriginal
        {
            get { return postoriginal; }
        }
    ...
    [Serializable]
    [XmlRoot("post")]
    public class PostOriginalModel
    {
        private string _id;
        [XmlElement("id")]
        public string id
        ...
        private PostOriginalDetailModel _deta;
        [XmlElement("detail")]
        public PostOriginalDetailModel deta
        {
            get { return _deta; }
            set { _deta = value; }
        }
        ...
        private PostOriginalModel _repost;
        [XmlElement("repost")]
        public PostOriginalModel repost
        {
            get { return _repost; }
            set { _repost = value; }
        }
    ...
    [Serializable]
    [XmlRoot("detail")]
    public class PostOriginalDetailModel
    {
